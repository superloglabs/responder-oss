...
CREATE INDEX "automation_model_usage_unbilled_idx" ON "automation_model_usage" USING btree ("created_at") WHERE "automation_model_usage"."inference_source" = 'responder' and "automation_model_usage"."billed_at" is null;--> statement-breakpoint
