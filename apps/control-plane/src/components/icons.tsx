...
function SupabaseLogo() {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M45.317 2.07103C48.1765-1.53037 53.9745.442937 54.0434 5.041L54.4849 72.2922H9.83113C1.64038 72.2922-2.92775 62.8321 2.1655 56.4175L45.317 2.07103Z"
        fill="#3ECF8E"
      />
      <defs>
        <linearGradient
...
function LinearLogo() {
  return (
    <svg aria-hidden="true" focusable="false" viewBox="0 0 100 100">
      <path
        d="M1.225 61.523c-.222-.949.908-1.546 1.597-.857l36.512 36.512c.689.689.092 1.819-.857 1.597C20.052 94.452 5.548 79.949 1.225 61.523ZM.002 46.889a.97.97 0 0 0 .29.761L52.35 99.709a.97.97 0 0 0 .761.289 50.22 50.22 0 0 0 6.962-.926c.765-.157 1.03-1.096.478-1.648L2.576 39.449c-.552-.552-1.491-.287-1.648.478a50.22 50.22 0 0 0-.926 6.962ZM4.211 29.705a.97.97 0 0 0 .208 1.1l64.776 64.776a.97.97 0 0 0 1.1.208 50.17 50.17 0 0 0 5.185-2.684c.552-.328.637-1.087.183-1.541L8.436 24.337c-.454-.454-1.213-.369-1.541.183a50.17 50.17 0 0 0-2.684 5.185Zm8.448-11.631a.97.97 0 0 1-.044-1.354C21.78 6.459 35.111 0 49.952 0 77.593 0 100 22.407 100 50.048c0 14.841-6.459 28.173-16.72 37.338a.97.97 0 0 1-1.354-.045L12.659 18.074Z"
        fill="currentColor"
      />
    </svg>
  );
