...
export const defaultInvestigationPromptParts: Record<string, string> = {
  ...
  "grafana": "Use the connected read-only Grafana tools to inspect relevant dashboards, alert rules, Prometheus metrics, Loki logs, traces, and profiles before concluding. Search dashboards and list datasources first to find the right datasource UIDs, and keep queries bounded to the incident window. Never create, update, or delete Grafana resources. Connected Grafana instances: {{value1}}.",
